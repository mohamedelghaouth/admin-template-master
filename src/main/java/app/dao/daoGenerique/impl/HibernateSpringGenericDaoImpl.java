...
import app.dao.daoGenerique.EntityNotFoundException;
import app.dao.daoGenerique.IgenericDao;
...
public abstract class HibernateSpringGenericDaoImpl<T, PK extends Serializable> implements IgenericDao<T, PK> {
